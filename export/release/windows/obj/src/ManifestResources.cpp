...
HXLINE(  75)		{
HXLINE(  75)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/week6.json",f4,c1,fb,f1));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week6",c2,95,be,c7),v2);
            		}
HXLINE(  76)		{
...
HXLINE(  85)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE(  86)		if (::hx::IsNotNull( library )) {
HXLINE(  86)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  87)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
